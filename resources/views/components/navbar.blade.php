...
<body class="bg-gray-50">
    ...
    <header
        class="fixed top-0 right-0 z-50 w-full bg-white backdrop-blur-md border-b border-white/30 shadow-sm px-6 md:px-24 py-2.5">
        <div class="flex items-center justify-between w-full md:px">
         ...
         flex-col md:flex-row gap-8 md:gap-4 text-center
         ...
         md:flex">
                <li class="pb-[10px] md:pb-0"><a
                        class="px-4 py-2 text-green-600 hover:text-white hover:bg-green-600 rounded-md"
                        href="/">Home</a></li>
                <li class="pb-[10px] md:pb-0"><a
                        class="px-4 py-2 text-green-600 hover:text-white hover:bg-green-600 rounded-md"
                ...
                <li class="md:hidden px-6 border-t-2 border-gray-200 pt-2">
                    <a href="/admin"
                        class="block border-2 border-[#29bb17] text-[#29bb17] text-[17px] py-2 rounded-md hover:bg-[#29bb17] hover:text-white p-0 m-0">Login</a>
                </li>
            </ul>

            <!-- Button Login Desktop -->
            <a href="/admin" class="hidden md:block bg-[#29bb17] text-white px-5 py-2 rounded-lg text-base font-medium">
                Login
            </a>
        </div>
    </header>
