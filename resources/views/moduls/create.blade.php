...
<head>
    ...
    <title>Project Mandiri - CRUD Hafidz</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('moduls.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">judul konten 1</label>
                                        <input type="text" class="form-control @error('price') is-invalid @enderror" name="judulkonten1" value="{{ old('price') }}" placeholder="Masukkan Harga Product">
                                ...
                                <textarea class="form-control @error('description2') is-invalid @enderror" name="description2" rows="5" placeholder="Masukkan Description Product">{{ old('description2') }}</textarea>
